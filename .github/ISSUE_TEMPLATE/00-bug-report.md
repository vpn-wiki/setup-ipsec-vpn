...
**Logs**
[Check logs and VPN status](https://github.com/vpn-wiki/setup-ipsec-vpn/blob/master/docs/clients.md#check-logs-and-vpn-status), and add relevant error logs to help explain the problem, if applicable.
